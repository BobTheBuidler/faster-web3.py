...
from benchmarks.web3.fixtures.beacon import (
    ...
    make_beacon_aiohttp_get,
    make_beacon_aiohttp_post,
)
...
def test_get_genesis(benchmark: BenchmarkFixture):
    ...
    with patch(
        AIOHTTP_CLIENT_SESSION_GET,
        new=make_beacon_aiohttp_get({"genesis": True}),
    ):
        benchmark(run_1000_async, beacon.get_genesis)
...
def test_get_hash_root(benchmark: BenchmarkFixture, state_id):
    ...
    with patch(
        AIOHTTP_CLIENT_SESSION_GET,
        new=make_beacon_aiohttp_get({"hash_root": state_id}),
    ):
        benchmark(run_1000_async, beacon.get_hash_root, state_id)
...
def test_get_fork_data(benchmark: BenchmarkFixture, state_id):
    ...
    with patch(
        AIOHTTP_CLIENT_SESSION_GET,
        new=make_beacon_aiohttp_get({"fork_data": state_id}),
    ):
        benchmark(run_1000_async, beacon.get_fork_data, state_id)
...
def test_get_finality_checkpoint(benchmark: BenchmarkFixture, state_id):
    ...
    with patch(
        AIOHTTP_CLIENT_SESSION_GET,
        new=make_beacon_aiohttp_get({"finality_checkpoint": state_id}),
    ):
        benchmark(run_1000_async, beacon.get_finality_checkpoint, state_id)
...
def test_get_validators(benchmark: BenchmarkFixture, state_id):
    ...
    with patch(
        AIOHTTP_CLIENT_SESSION_GET,
        new=make_beacon_aiohttp_get({"validators": state_id}),
    ):
        benchmark(run_1000_async, beacon.get_validators, state_id)
...
def test_get_validator_balances(benchmark: BenchmarkFixture, state_id):
    ...
    with patch(
        AIOHTTP_CLIENT_SESSION_GET,
        new=make_beacon_aiohttp_get({"validator_balances": state_id}),
    ):
        benchmark(run_1000_async, beacon.get_validator_balances, state_id)
...
def test_get_epoch_committees(benchmark: BenchmarkFixture, state_id):
    ...
    with patch(
        AIOHTTP_CLIENT_SESSION_GET,
        new=make_beacon_aiohttp_get({"epoch_committees": state_id}),
    ):
        benchmark(run_1000_async, beacon.get_epoch_committees, state_id)
...
def test_get_epoch_sync_committees(benchmark: BenchmarkFixture, state_id):
    ...
    with patch(
        AIOHTTP_CLIENT_SESSION_GET,
        new=make_beacon_aiohttp_get({"epoch_sync_committees": state_id}),
    ):
        benchmark(run_1000_async, beacon.get_epoch_sync_committees, state_id)
...
def test_get_epoch_randao(benchmark: BenchmarkFixture, state_id):
    ...
    with patch(
        AIOHTTP_CLIENT_SESSION_GET,
        new=make_beacon_aiohttp_get({"epoch_randao": state_id}),
    ):
        benchmark(run_1000_async, beacon.get_epoch_randao, state_id)
...
def test_get_block_headers(benchmark: BenchmarkFixture):
    ...
    with patch(
        AIOHTTP_CLIENT_SESSION_GET,
        new=make_beacon_aiohttp_get({"block_headers": True}),
    ):
        benchmark(run_1000_async, beacon.get_block_headers)
...
def test_get_block_header(benchmark: BenchmarkFixture, block_id):
    ...
    with patch(
        AIOHTTP_CLIENT_SESSION_GET,
        new=make_beacon_aiohttp_get({"block_header": block_id}),
    ):
        benchmark(run_1000_async, beacon.get_block_header, block_id)
...
def test_get_block(benchmark: BenchmarkFixture, block_id):
    ...
    with patch(
        AIOHTTP_CLIENT_SESSION_GET,
        new=make_beacon_aiohttp_get({"block": block_id}),
    ):
        benchmark(run_1000_async, beacon.get_block, block_id)
...
def test_get_block_root(benchmark: BenchmarkFixture, block_id):
    ...
    with patch(
        AIOHTTP_CLIENT_SESSION_GET,
        new=make_beacon_aiohttp_get({"block_root": block_id}),
    ):
        benchmark(run_1000_async, beacon.get_block_root, block_id)
...
def test_get_block_attestations(benchmark: BenchmarkFixture, block_id):
    ...
    with patch(
        AIOHTTP_CLIENT_SESSION_GET,
        new=make_beacon_aiohttp_get({"block_attestations": block_id}),
    ):
        benchmark(run_1000_async, beacon.get_block_attestations, block_id)
...
def test_get_blinded_blocks(benchmark: BenchmarkFixture, block_id):
    ...
    with patch(
        AIOHTTP_CLIENT_SESSION_GET,
        new=make_beacon_aiohttp_get({"blinded_blocks": block_id}),
    ):
        benchmark(run_1000_async, beacon.get_blinded_blocks, block_id)
...
def test_get_rewards(benchmark: BenchmarkFixture, block_id):
    ...
    with patch(
        AIOHTTP_CLIENT_SESSION_GET,
        new=make_beacon_aiohttp_get({"rewards": block_id}),
    ):
        benchmark(run_1000_async, beacon.get_rewards, block_id)
...
def test_get_light_client_bootstrap_structure(benchmark: BenchmarkFixture, block_root):
    ...
    with patch(
        ...
        benchmark(
            run_1000_async,
            beacon.get_light_client_bootstrap_structure,
            block_root,
        )
...
def test_get_light_client_updates(benchmark: BenchmarkFixture):
    ...
    with patch(
        AIOHTTP_CLIENT_SESSION_GET,
        new=make_beacon_aiohttp_get({"light_client_updates": True}),
    ):
        benchmark(run_1000_async, beacon.get_light_client_updates)
...
def test_get_attestations(benchmark: BenchmarkFixture):
    ...
    with patch(
        AIOHTTP_CLIENT_SESSION_GET,
        new=make_beacon_aiohttp_get({"attestations": True}),
    ):
        benchmark(run_1000_async, beacon.get_attestations)
...
def test_get_attester_slashings(benchmark: BenchmarkFixture):
    ...
    with patch(
        AIOHTTP_CLIENT_SESSION_GET,
        new=make_beacon_aiohttp_get({"attester_slashings": True}),
    ):
        benchmark(run_1000_async, beacon.get_attester_slashings)
...
def test_get_proposer_slashings(benchmark: BenchmarkFixture):
    ...
    with patch(
        AIOHTTP_CLIENT_SESSION_GET,
        new=make_beacon_aiohttp_get({"proposer_slashings": True}),
    ):
        benchmark(run_1000_async, beacon.get_proposer_slashings)
...
def test_get_voluntary_exits(benchmark: BenchmarkFixture):
    ...
    with patch(
        AIOHTTP_CLIENT_SESSION_GET,
        new=make_beacon_aiohttp_get({"voluntary_exits": True}),
    ):
        benchmark(run_1000_async, beacon.get_voluntary_exits)
...
def test_get_bls_to_execution_changes(benchmark: BenchmarkFixture):
    ...
    with patch(
        AIOHTTP_CLIENT_SESSION_GET,
        new=make_beacon_aiohttp_get({"bls_to_execution_changes": True}),
    ):
        benchmark(run_1000_async, beacon.get_bls_to_execution_changes)
...
def test_get_fork_schedule(benchmark: BenchmarkFixture):
    ...
    with patch(
        AIOHTTP_CLIENT_SESSION_GET,
        new=make_beacon_aiohttp_get({"fork_schedule": True}),
    ):
        benchmark(run_1000_async, beacon.get_fork_schedule)
...
def test_get_spec(benchmark: BenchmarkFixture):
    ...
    with patch(
        AIOHTTP_CLIENT_SESSION_GET,
        new=make_beacon_aiohttp_get({"spec": True}),
    ):
        benchmark(run_1000_async, beacon.get_spec)
...
def test_get_deposit_contract(benchmark: BenchmarkFixture):
    ...
    with patch(
        AIOHTTP_CLIENT_SESSION_GET,
        new=make_beacon_aiohttp_get({"deposit_contract": True}),
    ):
        benchmark(run_1000_async, beacon.get_deposit_contract)
...
def test_get_beacon_state(benchmark: BenchmarkFixture, state_id):
    ...
    with patch(
        AIOHTTP_CLIENT_SESSION_GET,
        new=make_beacon_aiohttp_get({"beacon_state": state_id}),
    ):
        benchmark(run_1000_async, beacon.get_beacon_state, state_id)
...
def test_get_beacon_heads(benchmark: BenchmarkFixture):
    ...
    with patch(
        AIOHTTP_CLIENT_SESSION_GET,
        new=make_beacon_aiohttp_get({"beacon_heads": True}),
    ):
        benchmark(run_1000_async, beacon.get_beacon_heads)
...
def test_get_node_identity(benchmark: BenchmarkFixture):
    ...
    with patch(
        AIOHTTP_CLIENT_SESSION_GET,
        new=make_beacon_aiohttp_get({"node_identity": True}),
    ):
        benchmark(run_1000_async, beacon.get_node_identity)
...
def test_get_peers(benchmark: BenchmarkFixture):
    ...
    with patch(
        AIOHTTP_CLIENT_SESSION_GET,
        new=make_beacon_aiohttp_get({"peers": True}),
    ):
        benchmark(run_1000_async, beacon.get_peers)
...
def test_get_peer(benchmark: BenchmarkFixture, peer_id):
    ...
    with patch(
        AIOHTTP_CLIENT_SESSION_GET,
        new=make_beacon_aiohttp_get({"peer": peer_id}),
    ):
        benchmark(run_1000_async, beacon.get_peer, peer_id)
...
def test_get_peer_count(benchmark: BenchmarkFixture):
    ...
    with patch(
        AIOHTTP_CLIENT_SESSION_GET,
        new=make_beacon_aiohttp_get({"peer_count": True}),
    ):
        benchmark(run_1000_async, beacon.get_peer_count)
...
def test_get_health(benchmark: BenchmarkFixture):
    ...
    with patch(
        AIOHTTP_CLIENT_SESSION_GET,
        new=make_beacon_aiohttp_get({"health": True}),
    ):
        benchmark(run_1000_async, beacon.get_health)
...
def test_get_version(benchmark: BenchmarkFixture):
    ...
    with patch(
        AIOHTTP_CLIENT_SESSION_GET,
        new=make_beacon_aiohttp_get({"version": True}),
    ):
        benchmark(run_1000_async, beacon.get_version)
...
def test_get_syncing(benchmark: BenchmarkFixture):
    ...
    with patch(
        AIOHTTP_CLIENT_SESSION_GET,
        new=make_beacon_aiohttp_get({"syncing": True}),
    ):
        benchmark(run_1000_async, beacon.get_syncing)
...
def test_get_blob_sidecars(benchmark: BenchmarkFixture, block_id, indices):
    ...
    with patch(
        AIOHTTP_CLIENT_SESSION_GET,
        new=make_beacon_aiohttp_get({"block": block_id, "indices": indices}),
    ):
        benchmark(run_1000_async, beacon.get_blob_sidecars, block_id, indices)
...
def test_get_block_proposer_duties(benchmark: BenchmarkFixture, epoch):
    ...
    with patch(
        AIOHTTP_CLIENT_SESSION_GET,
        new=make_beacon_aiohttp_get({"block_proposer_duties": epoch}),
    ):
        benchmark(run_1000_async, beacon.get_block_proposer_duties, epoch)
...
def test_get_attestations_rewards(
    ...
    with patch(
        ...
        benchmark(
            run_1000_async,
            beacon.get_attestations_rewards,
            epoch,
            validator_indices,
        )
