...
def test_get_genesis(benchmark: BenchmarkFixture):
    ...
    with patch(
        ...
        new=AsyncMock(side_effect=make_fake_aiohttp_request({"genesis": True})),
    ):
...
def test_get_hash_root(benchmark: BenchmarkFixture, state_id):
    ...
    with patch(
        "aiohttp.ClientSession.get",
        new=AsyncMock(side_effect=make_fake_aiohttp_request({"hash_root": state_id})),
    ):
...
def test_get_fork_data(benchmark: BenchmarkFixture, state_id):
    ...
    with patch(
        "aiohttp.ClientSession.get",
        new=AsyncMock(side_effect=make_fake_aiohttp_request({"fork_data": state_id})),
    ):
...
def test_get_finality_checkpoint(benchmark: BenchmarkFixture, state_id):
    ...
    with patch(
        "aiohttp.ClientSession.get",
        new=AsyncMock(
            side_effect=make_fake_aiohttp_request({"finality_checkpoint": state_id})
        ),
    ):
...
def test_get_validators(benchmark: BenchmarkFixture, state_id):
    ...
    with patch(
        "aiohttp.ClientSession.get",
        new=AsyncMock(side_effect=make_fake_aiohttp_request({"validators": state_id})),
    ):
...
def test_get_validator(benchmark: BenchmarkFixture, validator_id, state_id):
    ...
    with patch(
        "aiohttp.ClientSession.get",
        new=AsyncMock(
            side_effect=make_fake_aiohttp_request(
...
def test_get_validator_balances(benchmark: BenchmarkFixture, state_id):
    ...
    with patch(
        "aiohttp.ClientSession.get",
        new=AsyncMock(
            side_effect=make_fake_aiohttp_request({"validator_balances": state_id})
        ),
    ):
...
def test_get_epoch_committees(benchmark: BenchmarkFixture, state_id):
    ...
    with patch(
        "aiohttp.ClientSession.get",
        new=AsyncMock(
            side_effect=make_fake_aiohttp_request({"epoch_committees": state_id})
        ),
    ):
...
def test_get_epoch_sync_committees(benchmark: BenchmarkFixture, state_id):
    ...
    with patch(
        "aiohttp.ClientSession.get",
        new=AsyncMock(
            side_effect=make_fake_aiohttp_request({"epoch_sync_committees": state_id})
        ),
    ):
...
def test_get_epoch_randao(benchmark: BenchmarkFixture, state_id):
    ...
    with patch(
        "aiohttp.ClientSession.get",
        new=AsyncMock(
            side_effect=make_fake_aiohttp_request({"epoch_randao": state_id})
        ),
    ):
...
def test_get_block_headers(benchmark: BenchmarkFixture):
    ...
    with patch(
        "aiohttp.ClientSession.get",
        new=AsyncMock(side_effect=make_fake_aiohttp_request({"block_headers": True})),
    ):
...
def test_get_block_header(benchmark: BenchmarkFixture, block_id):
    ...
    with patch(
        "aiohttp.ClientSession.get",
        new=AsyncMock(
            side_effect=make_fake_aiohttp_request({"block_header": block_id})
        ),
    ):
...
def test_get_block(benchmark: BenchmarkFixture, block_id):
    ...
    with patch(
        "aiohttp.ClientSession.get",
        new=AsyncMock(side_effect=make_fake_aiohttp_request({"block": block_id})),
    ):
...
def test_get_block_root(benchmark: BenchmarkFixture, block_id):
    ...
    with patch(
        "aiohttp.ClientSession.get",
        new=AsyncMock(side_effect=make_fake_aiohttp_request({"block_root": block_id})),
    ):
...
def test_get_block_attestations(benchmark: BenchmarkFixture, block_id):
    ...
    with patch(
        "aiohttp.ClientSession.get",
        new=AsyncMock(
            side_effect=make_fake_aiohttp_request({"block_attestations": block_id})
        ),
    ):
...
def test_get_blinded_blocks(benchmark: BenchmarkFixture, block_id):
    ...
    with patch(
        "aiohttp.ClientSession.get",
        new=AsyncMock(
            side_effect=make_fake_aiohttp_request({"blinded_blocks": block_id})
        ),
    ):
...
def test_get_rewards(benchmark: BenchmarkFixture, block_id):
    ...
    with patch(
        "aiohttp.ClientSession.get",
        new=AsyncMock(side_effect=make_fake_aiohttp_request({"rewards": block_id})),
    ):
...
def test_get_light_client_updates(benchmark: BenchmarkFixture):
    ...
    with patch(
        "aiohttp.ClientSession.get",
        new=AsyncMock(
            side_effect=make_fake_aiohttp_request({"light_client_updates": True})
        ),
    ):
...
def test_get_attestations(benchmark: BenchmarkFixture):
    ...
    with patch(
        "aiohttp.ClientSession.get",
        new=AsyncMock(side_effect=make_fake_aiohttp_request({"attestations": True})),
    ):
...
def test_get_attester_slashings(benchmark: BenchmarkFixture):
    ...
    with patch(
        "aiohttp.ClientSession.get",
        new=AsyncMock(
            side_effect=make_fake_aiohttp_request({"attester_slashings": True})
        ),
    ):
...
def test_get_proposer_slashings(benchmark: BenchmarkFixture):
    ...
    with patch(
        "aiohttp.ClientSession.get",
        new=AsyncMock(
            side_effect=make_fake_aiohttp_request({"proposer_slashings": True})
        ),
    ):
...
def test_get_voluntary_exits(benchmark: BenchmarkFixture):
    ...
    with patch(
        "aiohttp.ClientSession.get",
        new=AsyncMock(side_effect=make_fake_aiohttp_request({"voluntary_exits": True})),
    ):
...
def test_get_bls_to_execution_changes(benchmark: BenchmarkFixture):
    ...
    with patch(
        "aiohttp.ClientSession.get",
        new=AsyncMock(
            side_effect=make_fake_aiohttp_request({"bls_to_execution_changes": True})
        ),
    ):
...
def test_get_fork_schedule(benchmark: BenchmarkFixture):
    ...
    with patch(
        "aiohttp.ClientSession.get",
        new=AsyncMock(side_effect=make_fake_aiohttp_request({"fork_schedule": True})),
    ):
...
def test_get_spec(benchmark: BenchmarkFixture):
    ...
    with patch(
        "aiohttp.ClientSession.get",
        new=AsyncMock(side_effect=make_fake_aiohttp_request({"spec": True})),
    ):
...
def test_get_deposit_contract(benchmark: BenchmarkFixture):
    ...
    with patch(
        "aiohttp.ClientSession.get",
        new=AsyncMock(
            side_effect=make_fake_aiohttp_request({"deposit_contract": True})
        ),
    ):
...
def test_get_beacon_state(benchmark: BenchmarkFixture, state_id):
    ...
    with patch(
        "aiohttp.ClientSession.get",
        new=AsyncMock(
            side_effect=make_fake_aiohttp_request({"beacon_state": state_id})
        ),
    ):
...
def test_get_beacon_heads(benchmark: BenchmarkFixture):
    ...
    with patch(
        "aiohttp.ClientSession.get",
        new=AsyncMock(side_effect=make_fake_aiohttp_request({"beacon_heads": True})),
    ):
...
def test_get_node_identity(benchmark: BenchmarkFixture):
    ...
    with patch(
        "aiohttp.ClientSession.get",
        new=AsyncMock(side_effect=make_fake_aiohttp_request({"node_identity": True})),
    ):
...
def test_get_peers(benchmark: BenchmarkFixture):
    ...
    with patch(
        "aiohttp.ClientSession.get",
        new=AsyncMock(side_effect=make_fake_aiohttp_request({"peers": True})),
    ):
...
def test_get_peer(benchmark: BenchmarkFixture, peer_id):
    ...
    with patch(
        "aiohttp.ClientSession.get",
        new=AsyncMock(side_effect=make_fake_aiohttp_request({"peer": peer_id})),
    ):
...
def test_get_peer_count(benchmark: BenchmarkFixture):
    ...
    with patch(
        "aiohttp.ClientSession.get",
        new=AsyncMock(side_effect=make_fake_aiohttp_request({"peer_count": True})),
    ):
...
def test_get_health(benchmark: BenchmarkFixture):
    ...
    with patch(
        "aiohttp.ClientSession.get",
        new=AsyncMock(side_effect=make_fake_aiohttp_request({"health": True})),
    ):
...
def test_get_version(benchmark: BenchmarkFixture):
    ...
    with patch(
        "aiohttp.ClientSession.get",
        new=AsyncMock(side_effect=make_fake_aiohttp_request({"version": True})),
    ):
...
def test_get_syncing(benchmark: BenchmarkFixture):
    ...
    with patch(
        "aiohttp.ClientSession.get",
        new=AsyncMock(side_effect=make_fake_aiohttp_request({"syncing": True})),
    ):
...
def test_get_blob_sidecars(benchmark: BenchmarkFixture, block_id, indices):
    ...
    with patch(
        ...
        new=AsyncMock(
            side_effect=make_fake_aiohttp_request(
                {"block": block_id, "indices": indices}
            )
        ),
    ):
...
def test_get_block_proposer_duties(benchmark: BenchmarkFixture, epoch):
    ...
    with patch(
        "aiohttp.ClientSession.get",
        new=AsyncMock(
            side_effect=make_fake_aiohttp_request({"block_proposer_duties": epoch})
        ),
    ):
