...
PyObject *CPyDef_to_hex_if_bytes(PyObject *cpy_r_val) {
    ...
    if (likely(PyUnicode_Check(cpy_r_val)))
        ...
        CPy_TypeErrorTraceback("faster_web3/_utils/type_conversion.py", "to_hex_if_bytes", 24, CPyStatic_globals, "str", cpy_r_val);
        goto CPyL28;
    }
    ...
    if (likely(PyUnicode_Check(cpy_r_val)))
        ...
        CPy_TypeErrorTraceback("faster_web3/_utils/type_conversion.py", "to_hex_if_bytes", 25, CPyStatic_globals, "str", cpy_r_val);
        goto CPyL28;
    }
    ...
    if (unlikely(cpy_r_r13 == NULL)) {
        CPy_AddTraceback("faster_web3/_utils/type_conversion.py", "to_hex_if_bytes", 25, CPyStatic_globals);
        goto CPyL29;
    }
    CPy_DECREF(cpy_r_r8);
    if (likely(PyUnicode_Check(cpy_r_r13)))
        ...
        CPy_TypeErrorTraceback("faster_web3/_utils/type_conversion.py", "to_hex_if_bytes", 25, CPyStatic_globals, "str", cpy_r_r13);
        goto CPyL28;
    }
...
CPyL12: ;
    ...
    cpy_r_r28 = CPyStatics[9]; /* 'to_hex' */
    cpy_r_r29 = CPyDict_GetItem(cpy_r_r27, cpy_r_r28);
    if (unlikely(cpy_r_r29 == NULL)) {
        CPy_AddTraceback("faster_web3/_utils/type_conversion.py", "to_hex_if_bytes", 26, CPyStatic_globals);
        goto CPyL32;
    }
    PyObject *cpy_r_r30[1] = {cpy_r_r26};
    cpy_r_r31 = (PyObject **)&cpy_r_r30;
    cpy_r_r32 = CPyStatics[20]; /* ('hexstr',) */
    cpy_r_r33 = PyObject_Vectorcall(cpy_r_r29, cpy_r_r31, 0, cpy_r_r32);
    ...
    if (likely(PyUnicode_Check(cpy_r_r33)))
        ...
        CPy_TypeErrorTraceback("faster_web3/_utils/type_conversion.py", "to_hex_if_bytes", 26, CPyStatic_globals, "str", cpy_r_r33);
        goto CPyL28;
    }
    return cpy_r_r34;
CPyL17: ;
    cpy_r_r35 = (PyObject *)&PyBytes_Type;
    cpy_r_r36 = CPyModule_builtins;
    cpy_r_r37 = CPyStatics[11]; /* 'bytearray' */
    ...
    cpy_r_r39.f0 = cpy_r_r35;
    cpy_r_r39.f1 = cpy_r_r38;
    cpy_r_r40 = PyTuple_New(2);
    if (unlikely(cpy_r_r40 == NULL))
        CPyError_OutOfMemory();
    PyObject *__tmp1 = cpy_r_r39.f0;
    PyTuple_SET_ITEM(cpy_r_r40, 0, __tmp1);
    PyObject *__tmp2 = cpy_r_r39.f1;
    PyTuple_SET_ITEM(cpy_r_r40, 1, __tmp2);
    cpy_r_r41 = PyObject_IsInstance(cpy_r_val, cpy_r_r40);
    ...
    cpy_r_r45 = CPyStatics[9]; /* 'to_hex' */
    cpy_r_r46 = CPyDict_GetItem(cpy_r_r44, cpy_r_r45);
    if (unlikely(cpy_r_r46 == NULL)) {
        CPy_AddTraceback("faster_web3/_utils/type_conversion.py", "to_hex_if_bytes", 28, CPyStatic_globals);
        goto CPyL28;
    }
    PyObject *cpy_r_r47[1] = {cpy_r_val};
...
CPyL23: ;
    ...
    cpy_r_r52 = CPyStatics[9]; /* 'to_hex' */
    cpy_r_r53 = CPyDict_GetItem(cpy_r_r51, cpy_r_r52);
    if (unlikely(cpy_r_r53 == NULL)) {
        CPy_AddTraceback("faster_web3/_utils/type_conversion.py", "to_hex_if_bytes", 28, CPyStatic_globals);
        goto CPyL28;
    }
    PyObject *cpy_r_r54[1] = {cpy_r_val};
    cpy_r_r55 = (PyObject **)&cpy_r_r54;
    cpy_r_r56 = CPyStatics[20]; /* ('hexstr',) */
    cpy_r_r57 = PyObject_Vectorcall(cpy_r_r53, cpy_r_r55, 0, cpy_r_r56);
...
CPyL26: ;
    if (likely(PyUnicode_Check(cpy_r_r50)))
        ...
        CPy_TypeErrorTraceback("faster_web3/_utils/type_conversion.py", "to_hex_if_bytes", 28, CPyStatic_globals, "str", cpy_r_r50);
        goto CPyL28;
    }
    return cpy_r_r58;
CPyL28: ;
...
__LL3: ;
    ...
    return retval;
fail: ;
    CPy_AddTraceback("faster_web3/_utils/type_conversion.py", "to_hex_if_bytes", 18, CPyStatic_globals);
    return NULL;
}
...
PyObject *CPyDef_to_bytes_if_hex(PyObject *cpy_r_val) {
    ...
    if (likely(PyUnicode_Check(cpy_r_val)))
        ...
        CPy_TypeErrorTraceback("faster_web3/_utils/type_conversion.py", "to_bytes_if_hex", 36, CPyStatic_globals, "str", cpy_r_val);
        goto CPyL8;
    }
    cpy_r_r2 = CPyStatic_globals;
    cpy_r_r3 = CPyStatics[12]; /* 'to_bytes' */
    cpy_r_r4 = CPyDict_GetItem(cpy_r_r2, cpy_r_r3);
    if (unlikely(cpy_r_r4 == NULL)) {
        CPy_AddTraceback("faster_web3/_utils/type_conversion.py", "to_bytes_if_hex", 36, CPyStatic_globals);
        goto CPyL9;
    }
    PyObject *cpy_r_r5[1] = {cpy_r_r1};
    cpy_r_r6 = (PyObject **)&cpy_r_r5;
    cpy_r_r7 = CPyStatics[20]; /* ('hexstr',) */
...
CPyL6: ;
    if (likely(PyBytes_Check(cpy_r_r9) || PyByteArray_Check(cpy_r_r9)))
        ...
        CPy_TypeErrorTraceback("faster_web3/_utils/type_conversion.py", "to_bytes_if_hex", 36, CPyStatic_globals, "bytes", cpy_r_r9);
        goto CPyL8;
    }
    return cpy_r_r10;
CPyL8: ;
...
__LL4: ;
    ...
    return retval;
fail: ;
    CPy_AddTraceback("faster_web3/_utils/type_conversion.py", "to_bytes_if_hex", 31, CPyStatic_globals);
    return NULL;
}
...
CPyL3: ;
    ...
    CPy_DECREF(cpy_r_r8);
    cpy_r_r9 = CPyStatics[22]; /* ('HexStr',) */
    cpy_r_r10 = CPyStatics[17]; /* 'eth_typing' */
    cpy_r_r11 = CPyStatic_globals;
    cpy_r_r12 = CPyImport_ImportFromMany(cpy_r_r10, cpy_r_r9, cpy_r_r9, cpy_r_r11);
    if (unlikely(cpy_r_r12 == NULL)) {
        CPy_AddTraceback("faster_web3/_utils/type_conversion.py", "<module>", 5, CPyStatic_globals);
        goto CPyL8;
    }
    CPyModule_eth_typing = cpy_r_r12;
    CPy_INCREF(CPyModule_eth_typing);
    CPy_DECREF(cpy_r_r12);
    cpy_r_r13 = CPyStatics[23]; /* ('to_bytes', 'to_hex') */
    cpy_r_r14 = CPyStatics[18]; /* 'eth_utils' */
    cpy_r_r15 = CPyStatic_globals;
    cpy_r_r16 = CPyImport_ImportFromMany(cpy_r_r14, cpy_r_r13, cpy_r_r13, cpy_r_r15);
    if (unlikely(cpy_r_r16 == NULL)) {
        CPy_AddTraceback("faster_web3/_utils/type_conversion.py", "<module>", 8, CPyStatic_globals);
        goto CPyL8;
    }
    CPyModule_eth_utils = cpy_r_r16;
    CPy_INCREF(CPyModule_eth_utils);
    CPy_DECREF(cpy_r_r16);
    cpy_r_r17 = CPyStatics[24]; /* ('Web3ValueError',) */
    cpy_r_r18 = CPyStatics[19]; /* 'faster_web3.exceptions' */
    cpy_r_r19 = CPyStatic_globals;
    cpy_r_r20 = CPyImport_ImportFromMany(cpy_r_r18, cpy_r_r17, cpy_r_r17, cpy_r_r19);
    if (unlikely(cpy_r_r20 == NULL)) {
        CPy_AddTraceback("faster_web3/_utils/type_conversion.py", "<module>", 13, CPyStatic_globals);
        goto CPyL8;
    }
    CPyModule_faster_web3___exceptions = cpy_r_r20;
...
const char * const CPyLit_Str[] = {
    "\a\0020x\000\034Expected a hex string. Got: \a{!r:{}}\006format\016Web3ValueError\006to_hex",
    "\b\006hexstr\tbytearray\bto_bytes\bbuiltins\005Union\006typing\006HexStr\neth_typing",
    "\002\teth_utils\026faster_web3.exceptions",
    "",
};
...
const int CPyLit_Tuple[] = {5, 1, 10, 1, 14, 1, 16, 2, 12, 9, 1, 8};
