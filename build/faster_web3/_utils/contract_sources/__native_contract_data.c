...
#include "__native_internal_contract_data.h"
...
int CPyExec_faster_web3____utils___contract_sources___contract_data(PyObject *module)
{
    ...
    CPyStatic_globals = PyModule_GetDict(CPyModule_faster_web3____utils___contract_sources___contract_data__internal);
...
PyObject *CPyInitOnly_faster_web3____utils___contract_sources___contract_data(void)
{
    ...
    CPyModule_faster_web3____utils___contract_sources___contract_data__internal = PyModule_Create(&module);
    return CPyModule_faster_web3____utils___contract_sources___contract_data__internal;
}
...
PyObject *CPyInit_faster_web3____utils___contract_sources___contract_data(void)
{
    ...
    rv = PyDict_GetItemStringRef(mod_dict, "faster_web3._utils.contract_sources.contract_data__mypyc", &shared_lib);
    if (rv < 0) goto fail;
...
char CPyDef___top_level__(void) {
    ...
    if (unlikely(cpy_r_r4 == NULL)) {
        CPy_AddTraceback("faster_web3/_utils/contract_sources/contract_data/__init__.py", "<module>", 1, CPyStatic_globals);
        goto CPyL4;
    }
...
CPyL4: ;
    ...
    static int exec_contract_data__mypyc(PyObject *module)
    {
        int res;
        PyObject *capsule;
        PyObject *tmp;
        ...
        capsule = PyCapsule_New((void *)CPyInit_faster_web3____utils___contract_sources___contract_data, "faster_web3._utils.contract_sources.contract_data__mypyc.init_faster_web3____utils___contract_sources___contract_data", NULL);
        if (!capsule) {
            goto fail;
        }
    ...
    static PyModuleDef module_def_contract_data__mypyc = {
        PyModuleDef_HEAD_INIT,
        .m_name = "faster_web3._utils.contract_sources.contract_data__mypyc",
        .m_doc = NULL,
        .m_size = -1,
        .m_methods = NULL,
    };
    PyMODINIT_FUNC PyInit_contract_data__mypyc(void) {
        static PyObject *module = NULL;
        if (module) {
            Py_INCREF(module);
            return module;
        }
        module = PyModule_Create(&module_def_contract_data__mypyc);
        if (!module) {
            return NULL;
        }
        if (exec_contract_data__mypyc(module) < 0) {
            Py_DECREF(module);
            return NULL;
        }
        return module;
