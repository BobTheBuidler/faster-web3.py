...
PyObject *CPyInitOnly_faster_web3____utils___contract_sources___contract_data___extended_resolver(void)
{
...
PyObject *CPyInit_faster_web3____utils___contract_sources___contract_data___extended_resolver(void)
{
    ...
    if (unlikely(CPyModule_faster_web3____utils___contract_sources___contract_data___extended_resolver__internal == NULL))
        goto fail;
    modname = PyUnicode_FromString("faster_web3._utils.contract_sources.contract_data.extended_resolver");
    if (modname == NULL) CPyError_OutOfMemory();
    int rv = 0;
    PyObject *mod_dict = PyImport_GetModuleDict();
    PyObject *shared_lib = NULL;
    rv = PyDict_GetItemStringRef(mod_dict, "faster_web3._utils.contract_sources.contract_data.extended_resolver__mypyc", &shared_lib);
    if (rv < 0) goto fail;
    ...
    Py_ssize_t is_pkg = 0;
    rv = CPyImport_SetDunderAttrs(CPyModule_faster_web3____utils___contract_sources___contract_data___extended_resolver__internal, modname, shared_lib_file, ext_suffix, is_pkg);
    Py_DECREF(ext_suffix);
    Py_DECREF(shared_lib_file);
    if (rv < 0) goto fail;
    if (PyObject_SetItem(PyImport_GetModuleDict(), modname, CPyModule_faster_web3____utils___contract_sources___contract_data___extended_resolver__internal) < 0)
        goto fail;
    Py_CLEAR(modname);
...
CPyL3: ;
    ...
    *(PyObject * *)cpy_r_r25 = cpy_r_r22;
    ...
    cpy_r_r70 = (CPyPtr)((CPyPtr)cpy_r_r69 + offsetof(PyListObject, ob_item));
    ...
    *(PyObject * *)cpy_r_r74 = cpy_r_r68;
    ...
    cpy_r_r104 = (CPyPtr)((CPyPtr)cpy_r_r103 + offsetof(PyListObject, ob_item));
    ...
    *(PyObject * *)cpy_r_r120 = cpy_r_r117;
    ...
    cpy_r_r142 = (CPyPtr)((CPyPtr)cpy_r_r141 + offsetof(PyListObject, ob_item));
    ...
    *(PyObject * *)cpy_r_r144 = cpy_r_r140;
    ...
    cpy_r_r156 = (CPyPtr)((CPyPtr)cpy_r_r155 + offsetof(PyListObject, ob_item));
    ...
    *(PyObject * *)cpy_r_r157 = cpy_r_r154;
    ...
    cpy_r_r186 = (CPyPtr)((CPyPtr)cpy_r_r185 + offsetof(PyListObject, ob_item));
    ...
    *(PyObject * *)cpy_r_r222 = cpy_r_r219;
    ...
    cpy_r_r229 = (CPyPtr)((CPyPtr)cpy_r_r228 + offsetof(PyListObject, ob_item));
