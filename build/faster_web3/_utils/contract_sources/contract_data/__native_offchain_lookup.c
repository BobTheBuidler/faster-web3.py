...
PyObject *CPyInitOnly_faster_web3____utils___contract_sources___contract_data___offchain_lookup(void)
{
...
PyObject *CPyInit_faster_web3____utils___contract_sources___contract_data___offchain_lookup(void)
{
    ...
    if (unlikely(CPyModule_faster_web3____utils___contract_sources___contract_data___offchain_lookup__internal == NULL))
        goto fail;
    modname = PyUnicode_FromString("faster_web3._utils.contract_sources.contract_data.offchain_lookup");
    if (modname == NULL) CPyError_OutOfMemory();
    int rv = 0;
    PyObject *mod_dict = PyImport_GetModuleDict();
    PyObject *shared_lib = NULL;
    rv = PyDict_GetItemStringRef(mod_dict, "faster_web3._utils.contract_sources.contract_data.offchain_lookup__mypyc", &shared_lib);
    if (rv < 0) goto fail;
    ...
    Py_ssize_t is_pkg = 0;
    rv = CPyImport_SetDunderAttrs(CPyModule_faster_web3____utils___contract_sources___contract_data___offchain_lookup__internal, modname, shared_lib_file, ext_suffix, is_pkg);
    Py_DECREF(ext_suffix);
    Py_DECREF(shared_lib_file);
    if (rv < 0) goto fail;
    if (PyObject_SetItem(PyImport_GetModuleDict(), modname, CPyModule_faster_web3____utils___contract_sources___contract_data___offchain_lookup__internal) < 0)
        goto fail;
    Py_CLEAR(modname);
...
CPyL3: ;
    ...
    cpy_r_r52 = (CPyPtr)((CPyPtr)cpy_r_r51 + offsetof(PyListObject, ob_item));
    ...
    *(PyObject * *)cpy_r_r106 = cpy_r_r103;
    ...
    cpy_r_r128 = (CPyPtr)((CPyPtr)cpy_r_r127 + offsetof(PyListObject, ob_item));
    ...
    *(PyObject * *)cpy_r_r143 = cpy_r_r140;
    ...
    cpy_r_r150 = (CPyPtr)((CPyPtr)cpy_r_r149 + offsetof(PyListObject, ob_item));
