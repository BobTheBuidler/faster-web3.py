...
PyInit_eth_tester(void)
{
    ...
    PyObject *capsule = PyObject_GetAttrString(tmp, "init_faster_web3___providers___eth_tester");
    Py_DECREF(tmp);
    if (capsule == NULL) return NULL;
    void *init_func = PyCapsule_GetPointer(capsule, "5f8b22f5f815a3776376__mypyc.init_faster_web3___providers___eth_tester");
    Py_DECREF(capsule);
    if (!init_func) {
        return NULL;
    }
...
PyMODINIT_FUNC PyInit___init__(void) { return PyInit_eth_tester(); }
