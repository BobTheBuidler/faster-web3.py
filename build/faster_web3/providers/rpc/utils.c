...
PyInit_utils(void)
{
    ...
    PyObject *capsule = PyObject_GetAttrString(tmp, "init_faster_web3___providers___rpc___utils");
    Py_DECREF(tmp);
    if (capsule == NULL) return NULL;
    void *init_func = PyCapsule_GetPointer(capsule, "5f8b22f5f815a3776376__mypyc.init_faster_web3___providers___rpc___utils");
    Py_DECREF(capsule);
    if (!init_func) {
        return NULL;
    }
